    ...
    <div class="row">
      ...
      ?>
          <div class="col-md-4 pb-3">
            <div class="card">
              <img src="./image/<?= $row['pimage'] ?>" class="card-img-top" alt="Product1>" style="margin: auto; height: 300px;" />
              <div class="card-body">
        ...
        if ($re->num_rows > 0) :
          ...
          ?>
            <div class="col-md-4 pb-3">
              <div class="card">
                <img src="./image/<?= $row['pimage'] ?>" class="card-img-top" alt="Product1>" 
                style="margin: auto; width: 300px; height: 250px;" />
                <div class="card-body">
                  <a href="detail.php?id=<?= $row['pid'] ?>" class="text-decoration-none">
                    <h5 class="card-title"><?= $row['pname'] ?></h5>
                  </a>
                  <h6 class="card-subtitle mb-2 text-muted"><span><i 
                  class="bi bi-currency-dollar"></i></span><?= $row['pprice'] ?></h6>
